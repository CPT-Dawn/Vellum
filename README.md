...
## Vellum Migration Note

This repository is being migrated to Vellum, a native TUI wallpaper engine.
Phase 0 removes standalone CLI coupling and converts daemon/runtime internals
into a reusable Rust library API exposed by the `awww-core` crate.
